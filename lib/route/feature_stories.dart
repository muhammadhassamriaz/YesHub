...
class FeatureStoriesScreen extends StatefulWidget {
  @override
  _FeatureStoriesScreenState createState() => _FeatureStoriesScreenState();
}

class _FeatureStoriesScreenState extends State<FeatureStoriesScreen> {
